...
std::pair<time_t, string> ABDClient::ReadGetPhase(std::string key, string& err) {
  ...
  ABDClient::AsyncCall<abdv2::ReadGetArg,abdv2::ReadGetRet>* get_call =
    new ABDClient::AsyncCall<abdv2::ReadGetArg,abdv2::ReadGetRet>();
  abdv2::ReadGetArg request;
  request.set_key(key);
  ...
  for(it = channels_.begin();it!=channels_.end();it++){
    ...
    abdv2::ReadGetRet* reply = new abdv2::ReadGetRet();
...
void ABDClient::ReadSetPhase(std::string key, std::string value, int max_ts, string& err) {
  ...
  ABDClient::AsyncCall<abdv2::ReadSetArg,abdv2::ReadSetRet> * set_call =
    new ABDClient::AsyncCall<abdv2::ReadSetArg,abdv2::ReadSetRet>();
  abdv2::ReadSetArg request;
  ...
  for (it = channels_.begin();it!=channels_.end();it++){
    ...
    abdv2::ReadSetRet* reply = new abdv2::ReadSetRet();
...
std::pair<time_t, int> ABDClient::WriteGetPhase(std::string key,
  ...
  ABDClient::AsyncCall<abdv2::WriteGetArg,abdv2::WriteGetRet>* get_call =
    new ABDClient::AsyncCall<abdv2::WriteGetArg,abdv2::WriteGetRet>();
  abdv2::WriteGetArg request;
  request.set_key(key);
  request.set_val(value);
  ...
  for (it = channels_.begin(); it!=channels_.end();it++){
    ...
    abdv2::WriteGetRet* reply = new abdv2::WriteGetRet();
    get_call->replies.emplace_back(reply);
...
void ABDClient::WriteSetPhase(std::string key, std::string value, int max_ts) {
  ...
  ABDClient::AsyncCall<abdv2::WriteSetArg,abdv2::WriteSetRet>* set_call =
    new ABDClient::AsyncCall<abdv2::WriteSetArg,abdv2::WriteSetRet>();
  abdv2::WriteSetArg request;
  ...
  for(it = channels_.begin();it!=channels_.end();it++){
    ...
    set_call->statuses.emplace_back(new Status());
    abdv2::WriteSetRet* reply = new abdv2::WriteSetRet(); 
    set_call->replies.emplace_back(reply);
    int i = counter;

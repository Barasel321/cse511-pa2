...
int main(int argc, char** argv) {
    ...
    std::string csv_path = "logs/" + input_path + "_Q" + server_addrs.size() + "_" + buf + ".csv";
    ...
    auto total_time = std::chrono::duration_cast<std::chrono::milliseconds>(tt_end - tt_start).count();
